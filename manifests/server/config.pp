class torque::server::config ( $torque_server       =  $torque::params::torque_server_name,
...
{
    class {'torque::server::baseconfig': torque_server => $torque_server }
    class {'torque::server::qmgrconfig': qmgr_server=>$qmgr_server , 
